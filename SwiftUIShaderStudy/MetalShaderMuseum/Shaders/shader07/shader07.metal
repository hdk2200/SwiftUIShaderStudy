...
// Scene Description
// Changed 'constant Shader07Parameters &params' to value 'Shader07Parameters params'
// to allow passing both constant buffer values and thread-local copies.
static float getDist(float3 p, float time, Shader07Parameters params) {
...
static float3 getNormal(float3 p, float time, Shader07Parameters params) {
...
static float3 getLight(float3 p, float3 rd, float time, Shader07Parameters params) {
